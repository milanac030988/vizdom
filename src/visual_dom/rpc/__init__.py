"""
gRPC transport for VizDOM model services
(ADR-017 detector, ADR-018 capture, ADR-019 actuator).
...
breaks inside a package):
    ...
    actuator_pb2_grpc.py:  import actuator_pb2  ->  from . import actuator_pb2
