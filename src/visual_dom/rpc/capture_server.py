...
Usage:
    ...
    python -m visual_dom.rpc.capture_server --strategy android --port 50053 --serial <dev>
...
from ..capture import create_capture, list_captures
...
def _load_stubs():
    import grpc
    from . import capture_pb2 as pb2
    from . import capture_pb2_grpc as pb2_grpc
...
def main():
    ...
    from ..capture import auto_select
