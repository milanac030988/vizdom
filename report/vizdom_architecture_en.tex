...
\code{visual\_dom} (config, generated, shared) & \code{config} (VizDomConfig), \code{generated} (protobuf stubs), \code{logging\_utils}; \code{evaluation} is a harness outside the hexagon. \\
