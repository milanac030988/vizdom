...
trực tiếp bởi tầng kiểm thử. Bảng~\ref{tab:arc42typeacc} định lượng ánh xạ này: khôi
phục vai trò từ tính tương tác, hình học và chú thích của OmniParser đã nâng độ chính
xác loại phần tử trên các điều khiển thao tác được từ \textbf{0.09} lên \textbf{0.87}.

\begin{table}[H]
  \centering\footnotesize
  \caption{Độ chính xác loại phần tử của OmniParser trên các điều khiển thao tác được
  khớp, trước và sau suy luận ánh xạ vai trò (tập kiểm tra tổng hợp).}
  ...
  \begin{tabular}{@{}lccccc@{}}
    ...
    Sau (chú thích + hình học) & \textbf{0.89} & \textbf{0.99} & \textbf{0.55} & 0.89 & \textbf{0.87} \\
    \bottomrule
  \end{tabular}
\end{table}

\noindent{\footnotesize $^\dagger$Ánh xạ cũ gán mọi phần tử phi văn bản là
\code{icon}, nên chỉ icon được tính đúng còn mọi vai trò khác đạt 0 --- đó là lý do
DOM không thể nhận ra bất kỳ điều khiển thao tác nào. Định vị không đổi; bảng này chỉ
đo \emph{loại}.}
