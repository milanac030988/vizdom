...
\begin{table}[H]
  ...
  khớp, qua hai giai đoạn cải tiến (tập kiểm tra tổng hợp): trước (chỉ text/icon), sửa
  lần đầu (tính tương tác + hình học), và hiện tại (+ chú thích + tinh chỉnh rộng/tỉ lệ).}
