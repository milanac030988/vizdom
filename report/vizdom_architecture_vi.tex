...
\code{visual\_dom} (config, generated, shared) & \code{config} (VizDomConfig), \code{generated} (protobuf stub), \code{logging\_utils}; \code{evaluation} là evaluation harness nằm ngoài kiến trúc lục giác. \\
